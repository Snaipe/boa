...
[![Builds](https://img.shields.io/github/actions/workflow/status/Snaipe/boa/test.yml?branch=main)](https://github.com/Snaipe/boa/actions/workflows/test.yml)
...
* JSON5
* TOML
* YAML (both 1.2 and 1.1, with merge keys extension, as well as StrictYAML)
